...
#Aim:-Create a basic voice assistant that can perform simple tasks based on voice commands.
#  Implement features like responding to "Hello" and providing predefined responses, telling the 
